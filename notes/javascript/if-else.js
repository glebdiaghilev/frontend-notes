...
// если в результате приведения будет false, то оператор останавливает работу, и все элементы вoзвращается в значении первого false, если все true то переменная будет последним true
